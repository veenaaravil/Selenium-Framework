...
public class AssertionClass extends BaseTest{
	...
	// Method to check whether URL contains specific string or not
	...
	public boolean verifyInnerText(WebElement element, String expectedText) {
		String actualText = element.getText();
		assertEquals(actualText, expectedText);
		return true;
	}
	...
	// Method to verify whether the element is enabled and available 
	public void elementEnabledAndAvailable(WebElement element) {
		elementAvailable(element, true);
		elementEnabled(element, true);
	}
